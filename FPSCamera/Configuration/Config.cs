namespace FPSCamera.Configuration
{
    ...
    public class Config : Base
    {
        ...
        [Config("LookAheadSeconds", "Look seconds ahead",
                "Seconds to look ahead by (depends on speed)")]
        public readonly CfFloat LookAheadSeconds = new CfFloat(1.5f, 0, 5);
        [Config("LookAheadPercent", "Look ahead Percent", "How much to turn toward look target.")]
        public readonly CfFloat LookAheadPercent = new CfFloat(50, 0, 100);
